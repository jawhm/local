<?php
	...
	$c_footer = '
		<div id="footer-jquerymobile" data-role="footer" data-position="fixed">
			<a class="footer-link-mobile" id="about-link" href="/system.html" data-ajax="false"><span>&nbsp;</span></a><a class="footer-link-mobile" id="seminar-link" href="/seminar/ser" data-ajax="false"><span>&nbsp;</span></a><a class="footer-link-mobile" id="visa-link" href="/country" data-ajax="false"><span>&nbsp;</span></a><a class="footer-link-mobile" id="school-link" href="/school.html" data-ajax="false"><span>&nbsp;</span></a><a class="footer-link-mobile" id="step-link" href="/start.html" data-ajax="false"><span>&nbsp;</span></a><a class="footer-link-mobile" id="menu-link" href="/#page" data-ajax="false"><span>&nbsp;</span></a>
		</div>
	';
	...
	if ($para1 == 'douji') {
		...
		$stt = $db->prepare('select *,date_format(starttime, \'%c月%e日 (%a) %k:%i\') as start from event_list where hiduke = :hiduke and starttime = :starttime and k_title2 = :k_title2 order by id');
		$stt->bindValue(':hiduke',    $seminar_info['hiduke']);
		$stt->bindValue(':starttime', $seminar_info['starttime']);
		$stt->bindValue(':k_title2',  $seminar_info['k_title2']);
		$stt->execute();
		$douji_list = array();
...
<div data-role="page" id="toppage" class="jquery">
    ...
    <div data-role="content">
        ...
        <div class="ui-grid-a large-text">
            <div class="ui-block-a"><img src="/css/images/new-rounded.png" alt="" style="position:relative;float:left;top:15px;left:10px;z-index:50;" /><a href="/seminar/ser/place/nagoya<?php echo ($use_area) ? '/area' : ''; ?>" data-mini="true" data-role="button" data-theme="d">名古屋</a></div>
        ...
        <div class="ui-grid-a large-text">
            ...
            <div class="ui-block-b"><a href="/seminar/ser/place/event<?php echo ($use_area) ? '/area' : ''; ?>" data-mini="true" data-role="button" data-theme="d">イベント</a></div>
        </div>
        ...
        <ul data-role="listview" data-inset="true" data-theme="a" data-dividertheme="a">
			...
			if ($_SESSION['mem_id'] != '' && $_SESSION['mem_name'] != '' && $_SESSION['mem_level'] != -1):?>
            <li data-icon="arrow-r-red" id="member-btn"><a href="/seminar/ser/page/member"><img src="/seminar/css/themes/images/icon7-18x18.png" alt="" class="ui-li-icon" />メンバー限定セミナーを予約する</a></li>
			<?php endif;?>
...
<?php
	...
	try {
		...
		$db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		$db->query('SET CHARACTER SET utf8');
		$rs = $db->query('SELECT id, year(hiduke) as yy, month(hiduke) as mm, day(hiduke) as dd, date_format(starttime, \'%c月%e日 (%a) %k:%i\') as start, date_format(starttime, \'%k:%i\') as starttime, title, memo, place, k_use, k_title1, k_desc1, k_desc2, k_stat, free, pax, booking FROM event_list WHERE id = '.$para2);
		$cnt = 0;
		$place_name = "";
	...
	elseif ($para1 == 'douji') {
		...
		<div data-role="page" id="doujipage" class="jquery">
			...
			<div data-role="content">
				...
				<div style="border: 1px dotted navy; margin: 20px 0 10px 0; padding: 10px 5px 10px 5px; font-size:10pt;">
					<table style="text-align: left;">
						<tr>
							<th>開催日時　　</th>
							<td><?php echo $douji_list[0]['start'] . '〜 '; ?></td>
						</tr>
						<tr>
							<th width="80px">セミナー名　</th>
							<td><?php echo $douji_list[0]['k_title1']; ?></td>
						</tr>
					</table>
				</div>
				<div style="margin: 20px 0 10px 0; padding: 10px 10px 10px 10px; font-size:11pt;">
					<p class="text01" style="text-align: center;">
						このセミナーは複数の会場で開催されます。<br>
						どの会場で予約しますか？<br><br><br>
					</p>
					<?php
					foreach ($douji_list as $one) :
						$one['place_name'] = translate_city($one['place']);
						echo '<a href="/seminar/ser/id/' . $one['id'] . '"><input type="button" name="' . $one['place'] . '" value="' . $one['place_name'] . '会場で予約する" /></a><br>';
					endforeach;
					?>
				</div>
			</div>
...
*/
		...
		else
		{
			...
			$query .=' hiduke >= DATE_SUB(CURDATE(),INTERVAL 0 DAY) '.$keyword.' ORDER BY hiduke, starttime, id  LIMIT 0,15';
		}
