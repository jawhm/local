...
$header_obj->fncMenuHead_h1text = 'ワーホリ・留学の語学学校セミナー情報';
...
$header_obj->fncMenuHead_imghtml = '<img id="top-mainimg" src="../seminar/images/seminar-mainimg-school.jpg" alt="" />';
...
<script type="text/javascript" src="../js/wz_tooltip.js"></script>
	  ...
	  <?php echo $header_obj->breadcrumbs(); ?>
		...
		<div style="float:left; padding-top:5px;">
		<a href="#school">
		<img src="/seminar/images/seminar_school_s4_c.jpg" onMouseOver="this .src='/seminar/images/seminar_school_s4_d.jpg'" onMouseOut="this .src='/seminar/images/seminar_school_s4_c.jpg'" alt="初心者向けセミナー" hspace="3">
		</a>
		</div>


            <h2 class="sec-title">語学学校セミナー</h2>
            <div style="Align="center" padding-top:5px; float:left; margin-bottom: 20px; width:100%;" >
		<a name="school" href="#schedule"><img src="/seminar/images/seminar_school2.png" alt="語学学校セミナー" hspace="10"></Div></a>

	<div style="float:left">
		<table style="margin: 10px 0 10px 20px; font-size:10pt;">
			<tr>
				<td width="45%"><b>【語学学校セミナー詳細】</b></td>
			</tr>
			<tr>
				<td>セミナー所要時間　　：　約1時間</td>
			</tr>
			...
			<tr>
				<td>特別セミナー講師　　：　学校スタッフ様</td>
			</tr>
		</table>
		<table style="margin: 10px 0 10px 20px; font-size:10pt;">
			<tr>
				<td>　※セミナー終了後、質疑応答の時間を授けます</td>
			</tr>
			<tr>
				<td>　※会場によっては中継での開催となります</td>
			</tr>
		</table>
		<table style="margin: 10px 0 10px 20px; font-size:10pt;">
			<tr>
			...
			<tr>
				<td>　①学校スタッフ様によるプレゼンテーション</td>
			</tr>
			<tr>
				<td>　②グループに分かれて質疑応答</td>
			</tr>
			<tr>
				<td>　※この際に学校スタッフ様と直接お話しして頂けます。</td>
			</tr>
		</table>
		</div>
		...
		<br/>
		<br/>
		<img src="/seminar/images/seminar_school_pic.png" alt="学校セミナー風景" align="left" hspace="60" >
		</div>
	</div>
		...
		※こちらには語学学校セミナーのみ掲載されております。その他のセミナーは<a href="http://www.jawhm.or.jp/seminar/seminar" target="_blank">こちら</a>からお探し下さい。
