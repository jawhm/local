...
<!--			<center><img src="images/copy.png"></center>-->
		...
		<clear="both" />
			...
			<div style="padding-left:20px; float:left; margin-bottom: 20px; width:100%;" >
				<div style="border: 2px dotted #cccccc; padding: 20px 20px 20px 20px; width: 90%; background-image : url(images/seminar.jpg);background-repeat : no-repeat; background-position : 96%">
					<img src="images/s-semianr.png" width="150px"><br/>
					<p>
					...
					<a href="#schedule"><img src="images/s-seminar-yoyaku_off.png" style="width: 70%; margin-top: 10px;"></a></a>
				</div>
			</div>
			...
			<div style="float: left; width: 269px; margin-left: 10px; border: 1px dotted #cccccc; padding: 10px 10px 0px 10px;">
				...
				<div align="right">
					<a href="#schedule"><img src="images/seminar_off.png" style="margin-top: 10px;"></a>
				</div><br/>
				<clear="both"/>
			</div>	
			...
			<div style="float: left; width: 269px; margin-left: 5px; border: 1px dotted #cccccc; padding: 10px 10px 0px 10px;" >
				...
				<a href="#schedule"><div align="right"><img src="images/seminar_off.png" style="margin-top: 10px;"></div><br/></a>
				<clear="both"/>
			</div>
		...
		<clear="both" />
			 ...
			 <div style="float:left; margin-bottom: 10px; width:95%;" >
...
-->
                <p style="text-align:right;padding-right:20px;margin-top:-10px;font-size:12px;">その他の都市でのセミナー開催日程は、<a href="/event.html" title="イベントカレンダー">イベントカレンダー</a>にてご案内いたします</p>
            ...
            <?php
                require_once './seminar_search_hatsuyume.php';
            ?>
            </div>
