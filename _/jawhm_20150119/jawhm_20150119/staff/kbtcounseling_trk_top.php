...
<?php
	...
	//画面情報
	//当画面の画面ＩＤ
	$gmn_id = 'kbtcounseling_trk_top.php';
	//遷移ＯＫとする遷移元の画面ＩＤ
	$ok_gmn = array('kbtcounseling_trk_selectstaff.php');
	...
	//エラーなし
		...
		print('<tr>');
		print('<td width="815" align="center">');
		//「対象のオフィスを選択してください。」
		print('<img src="./img_' . $lang_cd . '/title_select_office.png" border="0">');
		print('</td>');
