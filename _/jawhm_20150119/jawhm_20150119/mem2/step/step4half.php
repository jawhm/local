			...
			<div class="frame">
                    ...
                    <form id="payment" method="POST" action="https://www.digitalcheck.jp/settle/settle3/credit/settle_cr_cpt25.do">
                        ...
                        <table class="payment-process">
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="CARDNO" size="20" maxlength="16" class="focus" /><br/><small><strong>ハイフンは入力しないでください。</strong></small><br/><small style="color:#999999;display:block;width:10px;padding-left:50px;">例）9876543210123456
</small></td>
                            </tr>
                            <tr>
					...
					?>	
                            <table class="payment-process">
                                <tr>
                                    <td class="label-payment">お支払い金額</td>
                                    <td><strong><?php echo mb_convert_kana(number_format($k1),'A'); ?>円</strong><br /><small style="color:red;">（決済手数料（お客様負担） 218円が含まれています。）
</small></td>
                                </tr>
                                <tr>
