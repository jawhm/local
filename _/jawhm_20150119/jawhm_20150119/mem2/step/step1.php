	...
	-->
		<p class="title_bar">
			お客様の個人情報は暗号化通信（ＳＳＬ）により保護しております
		</p>
...
<script type="text/javascript" src="//seal.globalsign.com/SiteSeal/gmogs_image_130-66_ja.js" defer="defer"></script>
				...
				<td width="30">&nbsp;</td>
				<td>
・　このメンバー登録フォームはＧＭＯグローバルサインにより認証されており、お客様にご入力頂く個人情報は暗号化通信により保護しております。<br/>
・　日本ワーキングホリデー協会は、ＧＭＯグローバルサインの<a href="https://www.sslcerts.jp/" target="_blank">ＳＳＬサーバ証明書</a>を使用しています。<br/>
				</td>
			</tr>
		</table>
