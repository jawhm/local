...
$config1 = array(
	'view_mode' => 'list',
//	'seminar_id' => array('6070', '7180', '6947', '6195', '2014','7250','7197','7198'),
	'seminar_id' => array('6070', '7180', '6947', '6195', '2014','7250'),
	'list' => array(
		'count_field_active' => 'off',
		'past_view' => 'off',
	)
);
...
<div id="maincontent">
	...
	<div style="margin:20px 0 0 0 ;" id="semi_show1">
		<?php $count = $sm1->show(7250); echo "7250:".$count; echo var_dump($count); ?>
		<?php $count = $sm1->show(6195); echo "6195:".$count; ?>
	</div>
	<p>１間に自由にテキストを挿入できます。</p>
	<div style="margin:20px 0 0 0 ;" id="semi_show2">
		<?php $count = $sm1->show(7197); echo "7197:".$count; ?>
	</div>
	<p>２間に自由にテキストを挿入できます。</p>
	<div style="margin:20px 0 0 0 ;" id="semi_show3">
		<?php $count = $sm1->show(7198); echo "7198:".$count; ?>
	</div>
	<p>３間に自由にテキストを挿入できます。</p>
	<div style="margin:20px 0 0 0 ;" id="semi_show4">
		<?php $count = $sm1->show(6947); echo "6947:".$count; ?>
	</div>
	<p>４間に自由にテキストを挿入できます。</p>
	<div style="margin:20px 0 0 0 ;" id="semi_show5">
		<?php $count = $sm1->show(2014); echo "2014:".$count; ?>
	</div>
	<?php
	/*
	?>
