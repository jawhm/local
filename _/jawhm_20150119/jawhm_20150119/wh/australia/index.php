...
<div id="maincontent"> <?php echo $header_obj->breadcrumbs(); ?>
	<div class="wh_box">
		<div class="wh_box1">
...
?>
	...
	<table class="nittei">
      ...
      <td class="nittei_naiyou"><div class="nittei_title"> ワーキングホリデーだから、仕事でもしてみるか！！ </div>
        <div class="nittei_setumei"> 滞在資金を現地で稼ぐことができるのもワーキングホリデーの魅力の１つです。
          ...
          繰り返しになりますが、海外で仕事ができるビザは大変貴重です。ワーキングホリデーの魅力を生かし、ワーキングしてみましょう。 </div></td>
    </tr>
    <tr>
      <td class="nittei_span"><p>滞在期間</p> ７～９ヶ月目 </td>
      <td class="nittei_naiyou"><div class="nittei_title"> セカンドワーキングホリデービザの取得を目指して！！ </div>
        <div class="nittei_setumei"> オーストラリアのワーキングホリデービザの魅力として、セカンドワーキングホリデーという制度があり、このセカンドワーキングホリデービザを取ると最大２４カ月も、オーストラリアに滞在することが出来るようになります。<br/>
          ...
          セカンドワーキングホリデービザについてご説明する<a href="http://www.jawhm.or.jp/seminar.html">無料セミナー</a>もありますので、詳しいお話しをぜひ聞いてください。 </div></td>
    </tr>
    <tr>
      <td class="nittei_span"><p>滞在期間</p> １０～１２ヶ月目 </td>
      <td class="nittei_naiyou"><div class="nittei_title"> 気楽にオーストラリアを満喫！！ </div>
        <div class="nittei_setumei"> 英語も上達したし、その英語でオーストラリア人と一緒に仕事もできた。そんな自分に、ワーキングホリデー生活の最後にご褒美をあげましょう。そう。ホリデー（休暇）ですね。
          ...
          各国からワーキングホリデービザを利用してオーストラリアに来ている人に出会うチャンスもたくさんあります。オーストラリアに居ながら、世界中の人と友達になれるかもしれませんね。 </div></td>
    </tr>
  </table>
  <p class="text01"> これは、あくまでもワーキングホリデー生活のプランの１つです。先にも述べたとおり、ワーキングホリデーでは自由な滞在を楽しむ事ができます。この通りにワーキングホリデー生活を送る必要はありません。オーストラリアでのワーキングホリデー滞在期間中の出来事は、絶対に一生の思い出、また良い経験になります。
    帰国してから友達に自慢できるホリデー体験、ワーキングホリデー生活をぜひとも送ってください。そして、自分の将来のキャリアアップとなるワーキング経験をオーストラリアでたくさんしてください。<br/>
    英語だけじゃない、仕事（ワーキング）だけじゃない、遊び（ホリデー）だけでもない、あなただけのオーストラリア・ワーキングホリデーを楽しんでください。 </p>
  <p class="text01"> </p>
  ...
  <p style="color:red;text-align:center;margin-top:8px;"> ▼▼▼まずは無料セミナーへ！ワーキングホリデー＆留学の無料セミナーはこちら！▼▼▼ </p>
  <?php 
	//settings for the calendar module display
	$country_to_display = 'オーストラリア';
	$number_to_display = '2';
	...
	//display_horizontal_calendar($country_to_display,$number_to_display,$start_display_from);            
?>
  <p style="text-align:right; color:green; margin-right:20px;"> <a href="/seminar/seminar"><img src="../../images/canausseminar.gif" title="ワーキングホリデー＆留学無料セミナー毎日開催中！"/></a> <a href="/seminar/seminar">＞＞＞  無料セミナー情報をもっと見る</a> </p>
  <div class="top-move">
    <p><a href="#header">▲ページのＴＯＰへ</a></p>
  </div>
  <h2 id="st1-4" class="sec-title">オーストラリア・ワーキングホリデービザの特長</h2>
  <p class="text01"> オーストラリアのワーキングホリデービザは、日本人であればインターネットで申請をすることができます。<br/>
  ...
  <p class="text01"> オーストラリア政府は、日本人以外にも、アメリカ・カナダ・デンマーク・フランス・ドイツ・香港・イタリヤ・韓国・台湾・イギリス・インドネシア・マレーシア・タイなどなど、多くの国の方をワーキングホリデーとして受け入れています。<br/>
  ...
  <p class="text01"> また、通常ワーキングホリデービザでの滞在は最大１２ヶ月となりますが、セカンドワーキングホリデーを取得することにより最大２４カ月間の間、オーストラリアに滞在することが可能です。 </p>
  <p class="text01"> この様に、比較的簡単に、しかも長期間滞在できるオーストラリアのワーキングホリデービザですが、まだまだご案内した内容がたくさんあります。
...
?>
  ...
  <div class="wh_box">
    <div class="wh_box1">
      <div class="wh_div"><a href="http://www.jawhm.or.jp/system.html" class="wh_menu"><img src="../../images/label_big_01.jpg"><br/>
        ワーホリって何？</a></div>
      <div class="wh_div"><a href="../tame.php" class="wh_menu"><img src="../../images/label_big_02.jpg"><br/>
        ワーホリのタメになる話</a></div>
      <div class="wh_div"><a href="http://www.jawhm.or.jp/visa/v-aus.html" class="wh_menu"><img src="../../images/label_big_03.jpg"><br/>
        ワーホリビザの申請手順</a></div>
      <div class="wh_div"><a href="../canada/" class="wh_menu"><img src="../../images/label_big_04.jpg"><br/>
        カナダのワーホリ</a></div>
    </div>
  </div>
  <div style="clear:both; height:10px;">&nbsp;</div>
