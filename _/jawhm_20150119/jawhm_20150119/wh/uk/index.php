...
?>
	...
	イングランド
		...
		<p class="text01">
		イングランドの首都はロンドンで、世界で最も栄えている都市のひとつに挙げられるほどで、ワーキングホリデー（ワーホリ）の人気の高い都市です。他にもエンターテイメントの街ブライトンなどはイギリスにワーキングホリデー（ワーホリ）ビザで留学する人に人気の都市となっています。またイギリスでしっかりと勉強をしたい人には、伝統ある大学都市ケンブリッジとオックスフォードなどが人気で、ワーキングホリデー（ワーホリ）ビザではなく学生ビザでイギリスで留学した後、大学に進学する人も多いです。どの都市にもイギリスを代表する観光名所があり、語学学校もその都市に点在しているので、ワーキングホリデー（ワーホリ）中に勉強・仕事・観光と全てを体験することが出来る。</p>
		<p class="text01">
	...
	<table class="nittei">
		<tr>
			<td class="nittei_span"><p>注意点</p>その１</td>
		...
		<tr>
			<td class="nittei_span"><p>注意点</p>その２</td>
			<td class="nittei_naiyou">
				<div class="nittei_title">
		...
		<tr>
			<td class="nittei_span"><p>注意点</p>その３</td>
			<td class="nittei_naiyou">
				<div class="nittei_title">
					応募する時は悪徳業者にご注意！
				</div>
