...
?>
	  ...
	  <table class="tableofcontents">
		  ...
		  <td>
		    <ul>
			  ...
			  <li><a href="#st4">アメリカのここがすごい！</a></li>
			  <li><a href="#st5">アメリカのビザについて</a></li>
		    </ul>
		  </td>
		</tr>
	  </table>
	...
	<p class="text01">
	アメリカに留学する際気をつけなくてはならないのが、アメリカにはワーキングホリデーの制度がないということです。また、アメリカにはワーキングホリデー（ワーホリ）ビザの様に個人取得することができて就労することができるビザもないので、アメリカに留学する際は語学力を目的とするとよいでしょう。</p>
	<p class="text01">
	観光ビザや学生ビザも基本的にアメリカで働くこと目的としておらず、ワーキングホリデー（ワーホリ）ビザの様に自由に仕事を見つけることができません。ビザ取得自体もも各国ワーキングホリデー（ワーホリ）ビザと比較して手順が複雑です。</p>
	...
	<h2 id="st4" class="sec-title">アメリカのここがすごい！</h2>
	<p class="text01">
	アメリカもう一つの魅力として、国土の広さと都市の多さがあります。アメリカほど行く場所によって文化が変わる国はないでしょう。</p>
	<p class="text01">
	その理由はアメリカが合衆国であるためで、州によって法律や生活習慣などが大きく違います。ニューヨークやロサンゼルスのような大型都市から、ハワイやテキサスのように大自然に囲まれた州など、アメリカでは住む地域によって全く違う体験をすることができます。そのため、自分の目的に合った留学先を豊富なロケーションから選択することができます。</p>
	<p class="text01">
	...
	<p class="text01">
	またアメリカは様々なポップカルチャーの生みの親であることでも知られており、今まで多くの音楽や映画がアメリカで作られました。さらにアメリカは教育、医療、情報通信など様々な分野で常に世界をリードしてきた実績があり、アメリカへ留学することは、それらの様々なジャンルの最先端情報を手にすることが出来るということです。</p>
	<p class="text01">
	ワーキングホリデー（ワーホリ）制度のないアメリカへの留学が人気な理由は、このような要素が数多く存在するからでしょう。ワーキングホリデー（ワーホリ）制度がなくても、アメリカは日本人にって身近な国なのかもしれません。</p>
</p>

	<div class="top-move"><p><a href="#header">▲ページのＴＯＰへ</a></p></div>


	<h2 id="st5" class="sec-title">アメリカのビザについて</h2>
	<p class="text01">
	アメリカには数多くのビザが存在していますが、その中でもアメリカに渡航される人が良く使うビザが留学ビザ(F)と観光ビザ(B-2)です。</p>
	<p class="text01">
	注意して頂きたい点は、アメリカには現段階でワーキングホリデー（ワーホリ）制度がない点と、アメリカで個人取得できるビザは他国のビザやワーキングホリデー（ワーホリ）ビザと違い、アメリカでの就労が難しいという点です。</p>
	<p class="text01">
