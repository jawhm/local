...
<ul>
	...
	<li>
		<div class="hpanel" style="width:660px">
		<A Href="#seminar"><img src="04.png" style="float:left; padding-right:8px;" /></a>
		</div>
	</li>
...
<h2 class="sec-title" id="seminar">セミナースケジュール</h2><br /><br /><br /><br />
...
<div id="calshow" style="maring-top:0px; width:860px;">
	<div class="sponsorListHolder">
		...
		{
			$daystyle = '';
			if ( $days[1] == '0' )	{	$daystyle = 'color:#00FA9A;';	}
...
<div id="tokyo'.$days[0].'" style="display:none;">
		'.$cal_msg[$days[0]].'</table>
			...
			echo'
			<div class="calender" '.$divtitle.' style="border:1px solid orange; width:116px; height:160px; margin-bottom:4px; margin-left:3px; float:left; '.$pointstyle.'" '.$onclick.'>
				<div style="margin:3px 0 0 5px; font-size:14pt; font-weight:bold; '.$daystyle.'">'.$days[2].'</div>
				<div style="margin:3px 0 0 2px;">'.$cal_img[$days[0]].'</div>
			</div>
			';
		}
	?>
...
<h2 class="sec-title" id="school">語学学校のご紹介</h2><br /><br />

<TABLE style="border: 2px dotted #a6e82c; margin-top:36px; margin-left:-20px;" cellpadding="10" width="900px">

</tr>
	<tr>
		<TD  height="100px" width="120px">
	<center>
	<small>最新の設備とカリキュラム</small><br />
...
<table cellpadding="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      ...
      <td width="850" background="images/back.gif" style="padding: 20px 0px 0px 20px;">
