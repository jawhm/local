...
mb_internal_encoding("utf8");
	...
	$ok_url_payment 	= 'http://www.jawhm.or.jp/mem/payment.php';
	$wrong_url_payment	= 'http://www.jawhm.or.jp/mem/payment.php';
			...
			else
			{
				...
				{ 						
					...
					{  
						...
						//--------------------------------------------------------------
						if(!isset($payment_error) && (!isset($no_store)))
						{
							// 承認コード確認ＯＫ
							try {
								$db  = connexion_database();
						...
						else
						{
							if(isset($payment_error))
								$msg_payment = 'Payment Process erreur, Please try again。<br/>';
							else
...
<link rel="stylesheet" type="text/css"  href="./css/conbini_logo.css" />
<link rel="stylesheet" type="text/css"  href="./css/memberscript.css" />
...
<body>
	<?php fncMenuHead_nolink('<img id="top-mainimg" src="../images/mem-topbanner.jpg" alt="" width="970" height="170" />'); ?>
	
    <div id="contentsbox">
    	<img id="bgtop" src="../images/contents-bgtop.gif" alt="" />
