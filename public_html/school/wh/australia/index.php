...
<?	fncFacebookMeta();	?>
<title>オーストラリアでワーキングホリデー | 日本ワーキング・ホリデー協会</title>
<meta name="keywords" content="オーストラリア,ワーキングホリデー,ワーホリ,留学,ビザ,方法" />
<meta name="description" content="オーストラリアへワーキングホリデーや留学に行く方向けに準備・手続きの手順をご案内しています。その他様々な国でワーホリのビザの取得が可能で、最新のビザ取得方法や渡航情報などを発信しています。また、各種無料セミナーも開催しています。" />
...
<? fncMenuHead('<img id="top-mainimg" src="../../images/austop.gif" alt="" width="970" height="170" />', 'オーストラリアでワーキングホリデー | ワーホリについて'); ?>
...
<? fncMenubar(''); ?>
	...
	<div id="maincontent">
	  <p id="topicpath"><a href="/">トップ</a>　＞　オーストラリアでワーキングホリデー</p>
