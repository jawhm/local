      ...
      <div class="underSec access">
        ...
        <section class="normalBox">
          ...
          <div class="contentBox">        
            ...
            <div class="srcArea">
              <ul>
                <li><a class="btn Navy2" href="#tokyo">東京会場</a></li>
                <li><a class="btn Navy2" href="#osaka">大阪会場</a></li>
              </ul><!-- /.areaList -->
              <ul>
                <li><a class="btn Navy2" href="#nagoya">名古屋会場</a></li>
                <li><a class="btn Navy2" href="#fukuoka">福岡会場</a></li>
              </ul><!-- /.areaList -->
            </div><!-- /.btnArea -->
            
						<section class="areaBox" id="tokyo">
            	<h3>東京会場<span>TOKYO OFFICE</span></h3>
              <img src="../images/access/tokyoImg_sp.jpg" alt="東京会場写真">
              <p class="textArea">
              	〒160-0023<br>
                東京都新宿区西新宿1-3-3<br>
                品川ステーションビル新宿5階(507)<br><br>                
                ★JR新宿駅 西口 B16出口 より徒歩1分
              </p><!-- /.planeText -->
              <div class="btnShadow2 mgb20 w90"><a class="btn Orng" href="">東京開催のセミナーはこちら</a></div>
              <div class="mapArea">
              	...
              	<a class="btn mapBtn" href=""><span>行き方をみる</span></a>
              </div><!-- /.mapArea -->
            </section><!-- /.areaBox -->
            
						<section class="areaBox" id="osaka">
            	<h3>大阪会場<span>OSAKA OFFICE</span></h3>
              <img src="../images/access/osakaImg_sp.jpg" alt="大阪会場写真">
              <p class="textArea">
              	〒530-0001<br>
                大阪市北区梅田1-11-4-500<br>　
                大阪駅前第4ビル5階 19-1号室<br><br>               
                ★JR大阪駅より徒歩5分
              </p><!-- /.planeText -->
              <div class="btnShadow2 mgb20 w90"><a class="btn Orng" href="">大阪開催のセミナーはこちら</a></div>
              <div class="mapArea">
            ...
            <section class="areaBox" id="nagoya">
              ...
              <img src="../images/access/nagoyaImg_sp.jpg" alt="名古屋会場写真">
              <p class="textArea">
              	〒450-0002<br>
                名古屋市中村区名駅2-45-19<br>　
                桑山ビル8階A号室<br><br>                
              ...
              <div class="btnShadow2 mgb20 w90"><a class="btn Orng" href="">名古屋開催のセミナーはこちら</a></div>
              <div class="mapArea">
            ...
            <section class="areaBox" id="fukuoka">
              ...
              <img src="../images/access/fukuokaImg_sp.jpg" alt="福岡会場写真">
              <p class="textArea">
              	〒810-0004<br>
                福岡市中央区渡辺通4-6-20<br>　
                星野ビル6階1号室<br><br>                
              ...
              <div class="btnShadow2 mgb20 w90"><a class="btn Orng" href="">福岡開催のセミナーはこちら</a></div>
              <div class="mapArea">
