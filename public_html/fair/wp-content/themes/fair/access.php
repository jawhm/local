        ...
        <div class="contentBox">        
            ...
            <?php if (get_access_tokyo_status()): ?>
                <section class="areaBox" id="tokyo">
                    ...
                    <div class="mapArea">
                        <?php if (get_access_tokyo_map() != ''): ?>
                            <?php echo get_access_tokyo_map() ?>
                        <?php else: ?>
            ...
            <?php if (get_access_osaka_status()): ?>
                <section class="areaBox" id="osaka">
                    ...
                    <div class="mapArea">
                        <?php if (get_access_osaka_map() != ''): ?>
                            <?php echo get_access_osaka_map() ?>
                        <?php else: ?>
            ...
            <?php if (get_access_nagoya_status()): ?>
                <section class="areaBox" id="nagoya">
                    ...
                    <div class="mapArea">
                        <?php if (get_access_nagoya_map() != ''): ?>
                            <?php echo get_access_nagoya_map() ?>
                        <?php else: ?>
            ...
            <?php if (get_access_fukuoka_status()): ?>
                <section class="areaBox" id="fukuoka">
                    ...
                    <div class="mapArea">
                        <?php if (get_access_fukuoka_map() != ''): ?>
                            <?php echo get_access_fukuoka_map() ?>
                        <?php else: ?>
