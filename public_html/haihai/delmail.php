...
<?php
	...
	// クエリを送信する
	if($err_flg == 0){
		$sql = "SELECT vmail FROM maillist WHERE vsend = '0' AND haihai = 1";
	...
	if($err_flg == 0){
		...
		for($i=0; $i<count($email); $i++){
			...
			$sql .= "VALUES(NULL, '20', \"".$email[$i]."\", NULL, NULL, NULL, NULL,\"". $date."\", 0, NULL)";
			$result = mysql_query($sql, $link);
