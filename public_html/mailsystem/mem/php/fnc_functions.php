...
function GC_createEvent($client, $title = 'Tennis with Beth', $desc = 'Meet for a quick lesson', $where = '', $startDate = '2008-01-20', $startTime = '10:00', $endDate = '2008-01-20', $endTime = '11:00', $tzOffset = '+09') {
