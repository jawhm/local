...
function field_text($fld_name, $fld_size, $fld_value) {
    // テキスト
    $res = '';
    $res .= '<input id="' . $fld_name . '" type="text" name="' . $fld_name . '" size="' . $fld_size . '" value="' . htmlspecialchars(stripslashes($fld_value)) . '">';
    $res .= '';
    return $res;
}
...
function field_required($fld_name, $fld_size, $fld_value) {
    // テキスト
    $res = '';
    $res .= '<input id="' . $fld_name . '" type="text" name="' . $fld_name . '" size="' . $fld_size . '" value="' . htmlspecialchars(stripslashes($fld_value)) . '" required="yes">';
    $res .= '';
    return $res;
}
