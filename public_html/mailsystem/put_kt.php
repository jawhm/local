...
<h1 style="color:white;background-color:#525D76;font-size:22px;">協会（求職：外国人）の一括送信</h1>
<?php
...
if($_POST['submit'] != NULL){
	...
	try {
		...
		$rs = $db->query('SELECT vmail as email, vname1 as namae , vcheck FROM maillist WHERE vsend = "1" AND vtype = "kt"');
		$cnt = 0;
...
?>
	<form method="POST" action="put_kt.php" onsubmit="return(confirm('本当に送信しますか？'));">
		件名：<br />
