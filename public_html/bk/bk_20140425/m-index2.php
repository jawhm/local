...
<div id="menu"></div>
  <div class="wrapper">
    ...
    <div class="banArea mgb20">
		...
		<div class="advbox03" style="width: 300px; height: 69px; margin: 0 auto; padding-top: 10px; padding-bottom: 30px;">
			<?php
			// AIU2
			define('MAX_PATH', '/var/www/html/ad');
			if (@include_once(MAX_PATH . '/www/delivery/alocal.php')) {
    ...
    <footer>
      ...
      <div class="inBox">
        ...
        <p class="small" style="padding-top: 20px;">Copyright© JAPAN Association for Working Holiday Makers<br>All right reserved.</p>
      </div> 
    </footer>
