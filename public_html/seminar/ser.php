...
//	  $ids = array(180,180);
	...
	if($_SESSION['para1'] == 'kouen')	{
		...
		if ($para2 == 'kouen')		{	$page_tile .= '【体験談セミナー】';		}

		if ($para2 == 'student')	{	$page_tile .= '【情報収集セミナー】';		}

		if ($para2 == 'foot')		{	$page_tile .= '【人数限定懇談】';		}

		if ($para2 == 'abili')		{	$page_tile .= '【人気のセミナー】';	}

		if ($para2 == 'plan')		{	$page_tile .= '【プランニングセミナー】';	}
		...
		if ($para2 == 'usa')		{	$page_tile = 'アメリカの'.$page_tile;		}
	...
	<form action="/seminar/ser/book" method="post" id="form_yoyaku" data-ajax="false" onsubmit="return(fncyoyaku());">
		...
		<div data-role="fieldcontain">
			...
			<fieldset data-role="controlgroup">
				...
				<input type="tel" name="電話番号" id="tel" value="" />
...
<!--                           <option value="/seminar/ser/<?php print $para1.'/'.$para2.'/toyama/'.$para4; ?>" <?php if ($para3 == 'toyama') { print ' selected'; } ?>>富山</option>	-->
                            ...
                            <option value="/seminar/ser/<?php print $para1.'/'.$para2.'/event/'.$para4; ?>" <?php if ($para3 == 'event') { print ' selected'; } ?>>その他の会場</option>
                    ...
                    <div class="locallist<?php echo $display_title;?>">
                    	...
                    	<select name="select-choice-country" id="select-choice-country" class="select-choice" data-native-menu="true" data-theme="a">
                            ...
                            <optgroup label="興味のある国選択">
                                ...
                                <option value="/seminar/ser/<?php print $para1.'/'.$para2.'/'.$para3; ?>/usa" <?php if ($para4 == 'usa') { print ' selected'; } ?>>アメリカ</option>
                    ...
                    <p>セミナーの内容選択</p>
	             	...
	             	<select name="select-choice-know" id="select-choice-know" class="select-choice" data-native-menu="true" data-theme="a">
                        ...
                        <optgroup label="セミナーの内容選択">
                            ...
                            <option value="/seminar/ser/<?php print $para1.'/'.$para2.'/'.$para3; ?>/plan" <?php if ($para4 == 'plan') { print ' selected'; } ?>>プランニング法セミナー</option>

                            <option value="/seminar/ser/<?php print $para1.'/'.$para2.'/'.$para3; ?>/student" <?php if ($para4 == 'student') { print ' selected'; } ?>>情報収集セミナー</option>

                            <option value="/seminar/ser/<?php print $para1.'/'.$para2.'/'.$para3; ?>/foot" <?php if ($para4 == 'foot') { print ' selected'; } ?>>人数限定！懇談セミナー</option>

                            <option value="/seminar/ser/<?php print $para1.'/'.$para2.'/'.$para3; ?>/kouen" <?php if ($para4 == 'kouen') { print ' selected'; } ?>>体験談セミナー</option>
