...
$header_obj->fncMenuHead_h1text = '年内渡航相談会セミナー情報';
...
$header_obj->fncMenuHead_imghtml = '<img id="top-mainimg" src="../seminar/images/seminar-mainimg-sodan.jpg" alt="" />';
...
<script type="text/javascript" src="../js/wz_tooltip.js"></script>
	  ...
	  <?php echo $header_obj->breadcrumbs(); ?>
		...
		<div style="float:left; padding-top:5px;">
		<a href="#sodan">
		<img src="/seminar/images/seminar_sodan_s4_c.jpg" onMouseOver="this .src='/seminar/images/seminar_sodan_s4_d.jpg'" onMouseOut="this .src='/seminar/images/seminar_sodan_s4_c.jpg'" alt="初心者向けセミナー" hspace="3">
		</a>
		</div>
		...
		<img src="/seminar/images/seminar_school_s4.jpg" onMouseOver="this .src='/seminar/images/seminar_school_s4_b.jpg'" onMouseOut="this .src='/seminar/images/seminar_school_s4.jpg'" alt="初心者向けセミナー" hspace="3">
            ...
            <h2 class="sec-title">海外渡航相談会</h2>
            <div style="Align="center" padding-top:5px; float:left; margin-bottom: 20px; width:100%;" >
		<a name="sodan" href="#schedule"><img src="/seminar/images/seminar_sodan3.png" alt="年内渡航相談会セミナー" hspace="10"></Div></a>

		<div style="float:left">
			<table style="margin: 10px 0 10px 20px; font-size:10pt;">
				<tr>
					<td width="45%"><b>【海外渡航相談会　セミナー詳細】</b></td>
				</tr>
				<tr>
					<td>　セミナー所要時間　：　約１時間</td>
				</tr>
			...
			<table style="margin: 10px 0 10px 20px; font-size:10pt;">
				<tr>
					<td width="45%"><b>【相談会でお話する内容】</b></td>
				</tr>
				<tr>
					<td>　①　出発までに絶対するべきこと！</td>
				</tr>
				<tr>
					<td>　②　ワーホリ・留学するのにどの程度の語学力が必要なの？</td>
				</tr>
				<tr>
					<td>　③　仕事のいろは。仕事の種類、探し方、面接の受け方など</td>
				</tr>
				<tr>
					<td>　④　やっぱり気になるお金の事！予算の紹介</td>
				</tr>
				<tr>
					<td>　⑤　語学学校の紹介＆提案</td>
				</tr>
			...
			<table style="margin: 10px 0 10px 20px; font-size:10pt;">
				<tr>
					<td width="45%"><b>【海外渡航相談会の種類】</b></td>
				</tr>
				<tr>
					<td>　①　年内オーストラリア渡航計画相談会</td>
				</tr>
				<tr>
					<td>　②　年内カナダ渡航計画相談会</td>
				</tr>
				<tr>
					<td>　③　年内ニュージーランド渡航計画相談会</td>
				</tr>
				<tr>
					<td>　④　年内イギリス渡航計画相談会</td>
				</tr>
		...
		<br/>
		<br/>
		<img src="/seminar/images/seminar_sodan.png" alt="初心者向けセミナー風景" align="left" hspace="20" >
		</div>
		...
		※こちらには年内渡航計画相談会セミナーのみ掲載されております。その他のセミナーは<a href="http://www.jawhm.or.jp/seminar/seminar" target="_blank">こちら</a>からお探し下さい。
