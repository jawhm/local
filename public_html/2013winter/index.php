...
?>
	<div id="maincontent">
	  <?php echo $header_obj->breadcrumbs(); ?>
		...
		<clear="both" />
					<center><a href="#s2"><img src="images/yoyaku.gif" style="margin-top: -20px;"></a><br/></center>
			<div class="chiiki" style="background-color:#00592c; width: 644px; margin-left:15px; margin-bottom: 20px;" id="xmas_shoshin">セミナーに初めてご参加の方は【初心者向けセミナー】から！</div>
