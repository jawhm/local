...
$header_obj->title_page='日本全国留学・ワーキングホリデーセミナー2013';
...
$header_obj->fncMenuHead_h1text = '日本全国留学・ワーキングホリデーセミナー2013';
	  ...
	  <?php echo $header_obj->breadcrumbs(); ?>
		...
		<div style="border: 2px dotted navy; font-size:10pt; margin: 10px 10px 25px 10px; padding: 10px 20px 10px 20px;">
			...
			<br/>
				...
				<center>
					<a href="http://www.jawhm.or.jp/ja/5079"><img  src="http://www.jawhm.or.jp/ja/wp-content/uploads/2013/11/cda9a889e9b5e5e8704e810df86f8a8e.gif" width="49%"/></a> <a href="/event/iwateseminar/"><img src="http://www.jawhm.or.jp/images/uploads/files/banner.gif" width="49%"></a>
				</center>
			...
			<p class="text01">
				...
				<div align="center">▼　マップからお近くの会場名をクリック！　▼</div><br/>

			</p>

		<table style="background-image:url(images/seminarmap.gif); background-repeat:no-repeat; margin-bottom: 70px;" width="700px" height="430px" >

		<tr>

		<td>

		<div class="chiiki2" id="sendai"><img  src="images/sendai_off.png"  style="margin:-50px 0px 0px 490px" /></div><br />

		

		<div class="chiiki2" id="yokohama"><img  src="images/yokohama_off.png" style="margin:170px 0px 0px 430px" /></div><br />

				

		<div class="chiiki2" id="fukushima"><img  src="images/fukushima_off.png"  style="margin:-10px 0px 0px 480px" /></div><br />

	

		<div class="chiiki2" id="kagawa"><img  src="images/kagawa_off.png" style="margin:210px 0px 0px 110px" /></div><br />



		<div class="chiiki2" id="kyoto"><img  src="images/kyoto_off.png"  style="margin:155px 0px 0px 230px" /></div><br />



		<div class="chiiki2" id="omiya"><img  src="images/omiya_off.png" style="margin:35px 0px 0px 485px" /></div><br />



		<div class="chiiki2" id="kobe"><img  src="images/kobe_off.png"  style="margin:-60px 0px 0px 180px" /></div><br />



		<div class="chiiki2" id="hiroshima"><img  src="images/hiroshima_off.png" style="margin:-55px 0px 0px 40px" /></div><br />
	...
	<table style="margin-left:15px;">
		...
		<tr>
			...
			<td>
				...
				<div class="chiiki" style="background-color:#2bad36" id="yokohama">横浜</div><br/>

				<div class="chiiki" style="background-color:orange" id="kyoto">京都</div>

				<div class="chiiki" style="background-color:orange" id="kobe">神戸</div>

				<div class="chiiki" style="background-color:#f47527" id="kagawa">香川</div>

				<div class="chiiki" style="background-color:#ff7863" id="hiroshima">広島</div>
		...
		<p class="text01"><div align="center" style="font-size:13pt;"><b><a href="../../seminar.html">東京・大阪・名古屋・福岡・沖縄では通常通り随時開催中！</a></b></div></p>
