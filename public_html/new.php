		...
		if ($chk == 'ok')	{
			...
			if ($idx > 0)	{
				...
				if ($cur_state == '0')	{
					...
					$abort_msg .= 'ログインする場合は、こちらからどうぞ。<br/>';
...
<div id="header">
  ...
  <div id="contents">
	...
	<div id="maincontent">
	  <p id="topicpath"><a href="../index.html">トップ</a>　> メンバー登録 </p>
...
<form class="cmxform" id="signupForm" method="post" action="./new.php">
	...
	<table style="font-size:10pt;" border="1">
		<tr>
			...
			<td>
				<input id="email" name="email" size="36" maxlength="80" /><br/>
		...
		<tr>
			...
			<td><input id="namae" name="namae" maxlength="40" /></td>
		</tr>
		<tr>
			<td>フリガナ<span class="must">（必須）</span></td>
			<td><input id="furigana" name="furigana" maxlength="40" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				...
				<tr>
					<td>郵便番号</td>
					<td><input id="pcode" name="pcode" size=5 maxlength="10" /></td>
				</tr>
				<tr>
					<td>都道府県</td>
					<td><input id="add1" name="add1" size=20 maxlength="80" /></td>
				</tr>
				<tr>
					<td>市区町村</td>
					<td><input id="add2" name="add2" size=40 maxlength="80" /></td>
				</tr>
				<tr>
					<td>番地・建物名</td>
					<td><input id="add3" name="add3" size=40 maxlength="80" /></td>
				</tr>
				</table>
		...
		<tr>
			...
			<td><input id="tel" name="tel" maxlength="30" /></td>
		</tr>
		<tr>
			<td>職業</td>
			<td>
...
<div style="padding-left:30px;">
	...
	<table style="font-size:10pt;" border="1">
		...
		<tr>
			<td>ご案内メール</td>
			<td>
				<? if ($dat_mailsend == '0') { echo '受け取る'; } else { echo '受け取らない'; }	?>
			</td>
		</tr>
	</table>
