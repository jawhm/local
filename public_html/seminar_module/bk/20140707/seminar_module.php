...
<div class="open open_only" style="margin: 0;">セミナー詳細はココをClick!!</div>
<div class="det" style="border-color: rgb(255, 99, 71); display: none;width:460px;">' . nl2br($this->_douji_info[0]['k_desc1']) . '</div>
<br>
