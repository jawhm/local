...
$config1 = array(
	'view_mode' => 'list',
	'seminar_id' => array('7440', '7432', '7197'),
	'list' => array(
		'past_view' => 'on',
	//	'count_field_active' => '',
	)
...
<div id="maincontent">
	...
	<p>1間に自由にテキストを挿入できます。</p>
	<div style="margin:20px 0 0 0 ;" id="semi_show1">
		<?php $isView = $sm1->show(7432); ?>
	</div>
	<?php
	if ($isView) {
		echo '<p>atta</p>';
	...
	?>
	<p>2間に自由にテキストを挿入できます。</p>
	<div style="margin:20px 0 0 0 ;" id="semi_show2">
		<?php $isView = $sm1->show(7440); ?>
	</div>
	<?php
	if ($isView) {
		echo '<p>atta</p>';
	...
	?>
	<p>3間に自由にテキストを挿入できます。</p>
	<div style="margin:20px 0 0 0 ;" id="semi_show3">
		<?php $isView = $sm1->show(7197); ?>
	</div>
	<?php
	if ($isView) {
		echo '<p>atta</p>';
