...
<div id="maincontent"> <?php echo $header_obj->breadcrumbs(); ?>
  ...
  <div class="step_title"> オーストラリアでワーキングホリデー </div>
  ...
  <p class="text01"> オーストラリアと言って、みなさんは何を思い浮かべますか？コアラ、カンガルー、エアーズロック、グレートバリアリーフ...<br/>
  ...
  <p class="text01"> ワーキングホリデーでオーストラリアに行くという事は、オーストラリアで暮すという事になりますが、暮す上で一番大切な事は、安全である事。
  ...
  <center>
    <img src="../img/ausmap.gif" alt="オーストラリアの地図">
  </center>
  <p style="color:red;text-align:center;"> ▼▼▼まずは無料セミナーへ！ワーキングホリデー＆留学の無料セミナーはこちら！▼▼▼ </p>
  <?php 
...
?>
  ...
  <p class="text01"> ワーキングホリデーでオーストラリアに行く目的の１つに、語学の習得があります。いまどき英語の１つも喋れないとやっていけないよ。と言われ始めて何年経つでしょうか？人・物・金が世界中を簡単に移動できる現代において、より一層の国際化は否めません。
    ...
    言い換えると、もともと英語が母国語ではない方も多く暮らしている国、オーストラリア。言語・語学習得の苦労も分かち合え、つたない語学力であっても、それを受け入れ理解してくれる文化がオーストラリアにはあります。これは、オーストラリアで英語を勉強し上達させる上で、大変重要な要素です。 </p>
  <p class="text01"> また、オーストラリアは古くから移民を受け入れてきたという歴史もあり、オーストラリア国民にとっても、他の国の人々と暮らし、仕事や勉強をするという事は、まったく違和感のない事です。
    そしてオーストラリア政府は、外国語教育として日本語・インドネシア語・韓国語・中国語などのアジア諸国の言語を重視しています。特に日本語教育に力を入れており日本語が話せるオーストラリア人も多くいます。
    もし日本語が話せなかったとしても、オーストラリア人にとって日本は大変興味のある国であり、親日家も大変多いです。これが、オーストラリアの国民性です。 </p>
  <p class="text01"> ここでオーストラリアの噂話について１つ触れておきましょう。それは「オーストラリアの英語はなまっている」という話です。<br/>
    ...
    なまりは、オーストラリアだけのものでは無いという事です。 </p>
  <p class="text01"> これから世界中の多くの人が、より一層英語を話すようになり、英語でのコミュニケーションを行う時代が来るでしょう。<br/>
    ...
    多民族国家であるオーストラリアで、いろいろな人の英語に多く触れる。オーストラリア人の英語を勉強することも必要ですが、これが、これからの英語の勉強法と言えるでしょう。 </p>
  <p style="color:red;text-align:center;"> ▼▼▼まずは無料セミナーへ！ワーキングホリデー＆留学の無料セミナーはこちら！▼▼▼ </p>
  <?php 
	//settings for the calendar module display
	$country_to_display = 'オーストラリア';
...
?>
  ...
  <p class="text01"> ワーキングホリデーの魅力として、滞在期間中、自由な行動をとることが出来ます。<br/>
  ...
  <p class="text01"> 外国人（オーストラリア人以外）がオーストラリアに行く場合、オーストラリアへの渡航目的及び期間を明確にして、必要なビザ（査証）(※２)の取得が必要です。<br/>
    ...
    そんな事か...　と思われる方もいるかもしれませんが、ワーキングホリデービザような自由な行動がとれるビザは、大変珍しく、大変貴重なものなのです。オーストラリアに感謝です。 </p>
  <p class="text01"> 逆に、ワーキングホリデービザは自由であるが故に、せっかくのオーストラリア生活を満喫できず、大切なワーキングホリデービザを有効的に活用できない方が居る事も事実です。１８歳から３０歳までの方のみ、しかも一生に一回(※５)のこのチャンスを皆さんは是非活用して有意義なワーキングホリデー生活をオーストラリアで送ってください。<br/>
    ワーキング（仕事）とホリデー（休暇・交流）でワーキングホリデーです。仕事（ワーキング）も遊び（ホリデー）もめいいっぱい楽しんでください。 </p>
  <p class="text01"> ここで１つのワーキングホリデー生活１年間のプランを紹介します。（オーストラリア版）<br/>
  </p>
  <table class="nittei">
    <tr>
      <td class="nittei_span"><p>滞在期間</p> １～３ヶ月目 </td>
      <td class="nittei_naiyou"><div class="nittei_title"> まずは英語を勉強する！！ </div>
        <div class="nittei_setumei"> 語学力が心配な場合は、初めに語学学校で英語の勉強する事をおススメします。<br/>
    ...
    <tr>
      <td class="nittei_span"><p>滞在期間</p> ４～６ヶ月目 </td>
