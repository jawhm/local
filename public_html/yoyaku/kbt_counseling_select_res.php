...
<?php
	...
	//画面情報
	//当画面の画面ＩＤ
	$gmn_id = 'kbt_counseling_select_res.php';
	//遷移ＯＫとする遷移元の画面ＩＤ
	$ok_gmn = array('kbt_counseling_select_kkn.php','kbt_counseling_select_res.php');
...
//##############################################################
		...
		if( $err_flg == 0 && $err_cnt == 0 ){
			...
			if( $select_yyk_no == "" ){
				...
				print('<td colspan="3" align="center" valign="bottom" background="../img_' . $lang_cd . '/bg_pink_565x20.png"><font color="blue" size="5">' . sprintf("%05d",$yyk_no) . '</font></td>');
				print('</tr>');
				print('<tr>');
...
//				print('</tr>');
				...
				print('<div style="margin: 10px"><pre>' . $soudan . '</pre></div>');
				print('</td>');
				print('</tr>');
				print('</table>');
...
//			if( $err_kyoumi == 1 ){
//				print('<font color="red">エラー：興味のある国を入力してください。</font><br>');
//			}
//			$tabindex++;
...
//			if( $err_jiki == 1 ){
//				print('<font color="red">エラー：出発予定時期／希望時期を入力してください。</font><br>');
//			}
//			$tabindex++;
...
//			print('</table>');
			...
			if( $err_soudan == 1 ){
				print('<font color="red">エラー：相談内容を入力してください。</font><br>');
			}
			$tabindex++;
			print('<textarea name="soudan" rows="8" style="ime-mode:active; background-color: pink; width:100%; font-size: 15px; font-family: sans-serif;" tabindex="' . $tabindex . '" onfocus="this.style.backgroundColor=\'#cccccc\'" onblur="this.style.backgroundColor=\'#E0FFFF\'">' . $soudan . '</textarea>');
			print('</td>');
			print('</tr>');
			print('</table>');
			...
			print('<td width="565">&nbsp;</td>');
			//戻るボタン
			print('<form method="post" action="' . $sv_https_adr . 'yoyaku/kbt_counseling_select_jknkbn.php#' . $select_ymd . '">');
			print('<input type="hidden" name="prc_gmn" value="' . $gmn_id . '">');
			print('<input type="hidden" name="lang_cd" value="' . $lang_cd . '">');
			print('<input type="hidden" name="yykkey_ang_str" value="' . $yykkey_ang_str . '">');
			print('<input type="hidden" name="kaiin_id" value="' . $kaiin_id . '">');
			...
			print('<td width="565" align="center" valign="bottom" background="../img_' . $lang_cd . '/bg_pink_565x20.png"><font color="blue" size="5">' . sprintf("%05d",$tmp_nijyu_yyk_no) . '</font></td>');
			print('</tr>');
			print('<tr>');
			print('<td width="110" align="center" valign="middle" background="../img_' . $lang_cd . '/bg_mizu_110x20.png"><img src="./img_' . $lang_cd . '/title_mini_kaijyou.png" border="0"></td>');
			print('<td width="565" align="center" valign="bottom" background="../img_' . $lang_cd . '/bg_mizu_565x20.png"><font size="5">' . $zz_yykinfo_office_nm . '</font></td>');
			print('</tr>');
			print('<tr>');
			print('<td align="center" valign="middle" background="../img_' . $lang_cd . '/bg_kimidori_110x20.png"><img src="./img_' . $lang_cd . '/title_mini_nichiji.png" border="0"></td>');
			if( $zz_yykinfo_eigyoubi_flg == 1 || $zz_yykinfo_youbi_cd == 0 ){
...
//			print('<td align="center" valign="middle" background="../img_' . $lang_cd . '/bg_yellow_110x20.png"><img src="./img_' . $lang_cd . '/title_mini_jiki.png" border="0"></td>');
//			print('<td align="left" valign="middle" background="../img_' . $lang_cd . '/bg_yellow_565x20.png">');
//			print('&nbsp;&nbsp;' . $zz_yykinfo_jiki );
//			print('</td>');
//			print('</tr>');
			print('<tr>');
			print('<td align="center" valign="middle" background="../img_' . $lang_cd . '/bg_yellow_110x20.png"><img src="./img_' . $lang_cd . '/title_mini_soudannaiyou.png" border="0"></td>');
			print('<td align="left" valign="top" background="../img_' . $lang_cd . '/bg_yellow_565x20.png">');
			...
			//顧客情報が取得できなかった
				print('<br><font size="4" color="red">お手数ですが、始めからお願いします。</font><br><br>');
			
			}else if( $err_flg == 5 ){
				//満席になった
				print('<br><font size="4" color="red">選択した日時は満席となりました。<br><br>お手数ですが、始めからお願いします。</font><br><br>');
			 
			}else if( $err_flg == 7 ){
				//未来予約がある
				print('<br><font size="4" color="red">個別カウンセリングの予約は１人１件までとさせていただいております。<br><br>（選択した日時の予約はできませんでした。）</font><br><br>');

			}else if( $err_flg == 8 ){
				//過去日時を選択した
				print('<br><font size="4" color="red">選択した日時は過去日時のため予約できませんでした。</font><br><br>');

			}else if( $err_flg == 9 ){
					//予約が取り消されている（日時変更のみ）
				print('<br><font size="4" color="red">予約が取消されていますので、始めからお願いします。</font><br><br>');
