...
<?php
	...
	//画面情報
	//当画面の画面ＩＤ
	$gmn_id = 'kanri_office_del1.php';
	//遷移ＯＫとする遷移元の画面ＩＤ
	$ok_gmn = array('kanri_office_ksn0.php');
	...
	//エラーなし
		...
		if( $err_flg == 0 ){
			...
			if( $err_cnt == 0 ){
				...
				print('<tr>');
				print('<td width="815" align="center"><font color="blue">※以下のオフィスを削除します。よろしいですか？</font><br><font color="red" size="2">（まだ削除されていません。）</font></td>');
				...
				print('<td align="left" valign="top">');
				print('<b>オフィス名(*)</b>&nbsp;&nbsp;&nbsp;<br>');
				print('<font color="blue" size="5"><b>' . $select_office_nm . '</b>&nbsp;&nbsp;</font>');
				print('</td>');
				print('</tr>');
				print('</table>');
				...
				print('<form method="post" action="kanri_office_del2.php">');
				print('<td align="right">');
				...
				print('<table border="0">');
				print('<tr>');
				print('<td width="815" align="center"><font color="red">※該当オフィスに予約データが存在するため削除できません。</font></td>');
				print('<form method="post" action="kanri_office_ksn0.php">');
				print('<td align="right">');
				print('&nbsp;');
				print('</td>');
