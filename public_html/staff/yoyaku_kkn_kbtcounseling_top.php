...
<?php
	...
	//画面情報
	//当画面の画面ＩＤ
	$gmn_id = 'yoyaku_kkn_kbtcounseling_top.php';
	//遷移ＯＫとする遷移元の画面ＩＤ
	$ok_gmn = array('yoyaku_kkn_top.php','yoyaku_kkn_kbtcounseling_menu.php');
	...
	//エラーなし
		...
		print('<tr>');
		print('<td width="815" align="center"><font color="blue">※対象の会場を指定してください。</font></td>');
