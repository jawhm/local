...
<?php
	...
	//画面情報
	//当画面の画面ＩＤ
	$gmn_id = 'kanri_staff_top.php';
	//遷移ＯＫとする遷移元の画面ＩＤ
	$ok_gmn = array('kanri_top.php','kanri_staff_select.php','kanri_staff_trk0.php','kanri_staff_trk1.php','kanri_staff_trk2.php',
					'kanri_staff_ksn0.php','kanri_staff_ksn1.php','kanri_staff_ksn2.php','kanri_staff_del2.php');
	...
	//エラーなし
		...
		print('<tr>');
		print('<td width="815" align="center"><font color="blue">※登録対象の店舗を指定してください。</font></td>');
		...
		if( $err_flg == 0 ){
			...
			print('<form name="form1" method="post" action="kanri_staff_select.php">');
			print('<input type="hidden" name="prc_gmn" value="' . $gmn_id . '">');
			print('<input type="hidden" name="lang_cd" value="' . $lang_cd . '" />');
			print('<input type="hidden" name="office_cd" value="' . $office_cd . '" />');
			print('<input type="hidden" name="staff_cd" value="' . $staff_cd . '">');
			...
			print('<table  border="0">');
			print('<tr>');
			print('<td width="250" align="left"><img src="./img_' . $lang_cd . '/bar_officenm2.png"></td>');
			print('<td width="130" align="left" valign="bottom" rowspan="2" >');
			$tabindex++;
