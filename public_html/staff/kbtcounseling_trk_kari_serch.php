...
<title>個別カウンセリング（仮登録の会員検索）</title>
...
<?php
	...
	//画面情報
	//当画面の画面ＩＤ
	$gmn_id = 'kbtcounseling_trk_kari_serch.php';
	//遷移ＯＫとする遷移元の画面ＩＤ
	$ok_gmn = array('yoyaku_kkn_kbtcounseling_kkn.php',
					'kbtcounseling_trk_kari_new0.php','kbtcounseling_trk_kari_new1.php','kbtcounseling_trk_kari_new2.php',
					'kbtcounseling_trk_kari_serch_kkn0.php');
	...
	//エラーなし
		...
		if( $prc_gmn == 'kbtcounseling_trk_kari_serch_kkn0.php' ){
